...
public class Du_A100000 : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        //判断有没有数据
        int count_i=(Int32)SqlHelper.ExecuteScalar("select count(*) from BasicIndicateValue where FinancialTable_Numbers='Ta020001' and FinanceYear="+year_str+" and Companys_Numbers='"+companysnumbers_str+"';");
        if (count_i==0)
        {
            //先获取需要的基础指标 Ta020001
