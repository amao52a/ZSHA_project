...
public class Du_DutyAlert : IHttpHandler {
    ...
    private void DoWork(HttpContext context)
    {
        ...
        try{
            ...
            {
                //增值税本月
                string taxtype = "Ta010001,Ta010002,Ta010003,Ta010004";
                ...
                string sql_str = "select FinancialTable_Numbers from BasicIndicateValue where Companys_Numbers='" + username_str + "' and FinanceYear=" + year_str + " and FinanceMonth=" + int.Parse(month_str) + " group by FinancialTable_Numbers";
                ...
                if (taxtype.Length > 8)
                {
                    string mrs = ph.getTax(username_str, password_str, year_str + month_str + "01", year_str + month_str + day_str, "1", taxtype);
                    json_str += "[{\"month\":" + mrs + "},";
                }
                else
                {
                ...
                //增值税上月
                taxtype = "Ta010001,Ta010002,Ta010003,Ta010004";
                ...
                sql_str = "select FinancialTable_Numbers from BasicIndicateValue where Companys_Numbers='" + username_str + "' and FinanceYear=" + year_str + " and FinanceMonth=" + int.Parse(month_str) + " group by FinancialTable_Numbers";
                ...
                if (taxtype.Length > 8)
                {
                    string mlrs = ph.getTax(username_str, password_str, year_str + month_str + "01", year_str + month_str + day_str, "1", taxtype);
                    json_str += "{\"lastmonth\":" + mlrs + "},";
                }
                else
                {
                    json_str += "{\"lastmonth\":[]},";
            ...
            //当没有勾选增值税的时候，补充完成空返回值
            else
            {
                json_str += "[{\"month\":[]},{\"lastmonth\":[]},";
            }
            ...
            context.Application[Progress_key] = null;
            context.Response.Write("[{\"month\":[]},{\"lastmonth\":[]},{\"year\":[]},{\"lastyear\":[]},{\"numbers\":\"error\"}]");
        }
    }
