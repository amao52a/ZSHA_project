...
public class Du_A104000 : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        //判断有没有数据
        SqlHelper.ExecuteNonQuery("delete from BasicIndicateValue where FinancialTable_Numbers='Ta020003' and FinanceYear="+year_str+" and Companys_Numbers='"+companysnumbers_str+"';");
        //先获取需要的基础指标 Ta020003
