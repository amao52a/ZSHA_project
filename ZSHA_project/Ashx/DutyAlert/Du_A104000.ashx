<%@ WebHandler Language="C#" Class="Du_A104000" %>
...
public class Du_A104000 : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        //判断有没有数据
        int count_i=(Int32)SqlHelper.ExecuteScalar("select count(*) from BasicIndicateValue where FinancialTable_Numbers='Ta020003' and FinanceYear="+year_str+" and Companys_Numbers='"+companysnumbers_str+"';");
        if (count_i==0)
        {
            //先获取需要的基础指标 Ta020003
            DataTable dt= SqlHelper.ExecuteDataTable("select * from BasicIndicate where FinancialTable_Numbers='Ta020003'");
            foreach(DataRow dr in dt.Rows)
            {
                ...
                SqlParameter[] parameters ={ new SqlParameter("@BasicIndicate_Numbers", dr["Numbers"]),
                    ...
                    new SqlParameter("@FinancialTable_Numbers", "Ta020003")};
